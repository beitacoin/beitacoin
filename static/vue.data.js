    ...
    data: {
        language:{
            Chinese: {
                ...
                news1_tit:'关于EXPC节点数量、参与条件及奖励的调整公告',
                news1_con:'EXPC全球社区玩家，为了更好扩大与推动EXPC指数链的共识，现做以下调整: </br>1.将节点增加到1930个</br>2.节点参与条件调整为:</br></br>初级节点:1000美金的EOS</br>中级节点:5000美金的EOS</br>高级节点:10000美金的EOS</br>3.节点奖励调整为:</br>初级节点:10% EOS</br>中级节点:20% EOS  + 5% EXPC</br>高级节点:30% EOS  + 10% EXPC</br>4.原有节点，只需新购买一个EOS的EXPC,即可完成节点升级',
                news2_tit:'关于EXPC上交易所开盘价格公告',
                news2_con:'EXPC全球玩家，EXPC登录交易所的开盘价格确定为 1 USDT',
                news1_time:'2019-10-02',
            ...
            English: {
                sell:'Sell<br><br>out ',
                news2_time:'2019-09-22',
                news1_time:'2018-10-02',
                news1_tit:'Announcement on the adjustment on the number of EXPC nodes, participation requirements and reward rules',
                news1_con:'To the EXPC global community players, in order to expand and promote the consensus of the EXPC index chain better, the following adjustments are made:</br>1.       Increase the number of nodes to 1930</br>2.       The participation requirements for node are adjusted to be:</br>Primary node: $1000 EOS</br>Intermediate node: $5,000 EOS</br>Advanced node: $10,000 EOS</br>3. The rewards to node are adjusted to be:</br>Primary node: 10% EOS</br>Intermediate node: 20% EOS + 5% EXPC</br>Advanced node: 30% EOS + 10% EXPC</br>3.       The existed node can be upgraded by purchasing a new EOS EXPC.',
